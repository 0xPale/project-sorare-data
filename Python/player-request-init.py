...
while sliceEnd < lenPlayerList:
    ...
    if r.status_code == 200: #success
        ...
        with open(outputFolder + outputJSONPlayer +'allPlayerScore_' + str(sliceStart) + '.json', 'w') as json_file:
      ...
      time.sleep(60)
      print("Status code 429 - Waited for 60s")
  
    elif r.status_code == 502: #Time out
      time.sleep(60)
      print("Status code 502 - Waited for 60s")
